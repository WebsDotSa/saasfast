...
import { ArrowLeft, Percent, DollarSign, Truck, Package, Gift } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        throw new Error(data.error || 'فشل إنشاء الخصم');
      }
    } catch (error: any) {
      toast({
        title: 'خطأ',
        description: error.message || 'فشل إنشاء الخصم',
        variant: 'destructive',
      });
    } finally {
      setLoading(false);
  ...
  return (
    <div className="space-y-6" dir="rtl">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">إنشاء خصم جديد</h1>
          <p className="text-muted-foreground mt-1">
            أضف عرضاً ترويجياً جديداً لزيادة مبيعاتك
          </p>
        </div>
      </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  اختر نوع الخصم الذي تريد إنشاؤه
                </CardDescription>
              </CardHeader>
              <CardContent>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      اتركه فارغاً لعدم وجود حد أدنى
                    </p>
                  </div>
                  <div className="space-y-2">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    الخصومات ذات الأولوية الأعلى تُطبق أولاً
                  </p>
                </div>
              </CardContent>
            </Card>
